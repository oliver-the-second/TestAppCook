...
fun DependencyHandlerScope.androidBase(isComposeEnabled:Boolean = true) {
    if(isComposeEnabled){
        compose()
    }else {
        implementation(
...
private fun DependencyHandlerScope.jetpackNavigation() {
...
fun DependencyHandlerScope.xml() = implementation(
...
fun DependencyHandlerScope.ktor() = implementation(
    ...
    "io.ktor:ktor-client-serialization:$ktorVer",
    "io.ktor:ktor-client-android:$ktorVer",
)
